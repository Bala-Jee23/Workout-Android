...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupRestView()
        setupStatusExerciseRecyclerView()
    }
    ...
    private fun setupRestView(){
        try{
            val soundURI = Uri.parse("android.resource://com.example.a7min_workout/"+ R.raw.press_start)
        ...
        binding?.imageExercise?.visibility=View.INVISIBLE
    ...
    private  fun setExerciseProgressBar(){
        ...
        exerciseTimer = object :CountDownTimer(30000,1000){
            ...
            override fun onFinish() {
                ...
                exerciseAdapter?.notifyDataSetChanged()
                if(currentExercisePosition<exerciseList?.size!!-1)setupRestView()
                else {
                    Toast.makeText(this@ExerciseActivity, "Congrats U R Done.", Toast.LENGTH_SHORT).show()
                    finish()
                    val intent=Intent(this@ExerciseActivity,EndingActivity::class.java)
    ...
    private fun setupStatusExerciseRecyclerView(){
